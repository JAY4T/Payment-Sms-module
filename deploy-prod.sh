...
COMMIT_HASH=$1
RELEASES_DIR="/home/pipeline/releases/paymentsms_prod"
DEPLOY_BIN="/home/pipeline/production/paymentsms_prod/paymentsms.jar"
SERVICE_NAME="paymentsms_prod.service"
